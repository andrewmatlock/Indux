	...
	theme: {
		extend: {
			...
			colors: {
				...
				"form": "color-mix(in srgb, var(--color-form-surface) calc(<alpha-value> * 100%), transparent)",
				...
				"main": "color-mix(in srgb, var(--color-text-main) calc(<alpha-value> * 100%), transparent)",
			...
			spacing: {
				...
				"xl": "var(--spacing-xl)",
				"2xl": "var(--spacing-2xl)",
				"form": "var(--spacing-form)",
				"form-size": "var(--spacing-form-height)",
