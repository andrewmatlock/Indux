	...
	theme: {
		extend: {
			...
			colors: {
				...
				"stark": "color-mix(in srgb, var(--color-content-stark) calc(<alpha-value> * 100%), transparent)",
				"main": "color-mix(in srgb, var(--color-content-stark) calc(<alpha-value> * 100%), transparent)",
				"neutral": "color-mix(in srgb, var(--color-content-neutral) calc(<alpha-value> * 100%), transparent)",
				"subtle": "color-mix(in srgb, var(--color-content-subtle) calc(<alpha-value> * 100%), transparent)",
				"line": "color-mix(in srgb, var(--color-line) calc(<alpha-value> * 100%), transparent)",
				"primary": "color-mix(in srgb, var(--color-brand-surface) calc(<alpha-value> * 100%), transparent)",
				"brand-inverse": "color-mix(in srgb, var(--color-brand-inverse) calc(<alpha-value> * 100%), transparent)",
				"brand-text": "color-mix(in srgb, var(--color-brand-content) calc(<alpha-value> * 100%), transparent)",
				"accent": "color-mix(in srgb, var(--color-accent-surface) calc(<alpha-value> * 100%), transparent)",
				"accent-inverse": "color-mix(in srgb, var(--color-accent-inverse) calc(<alpha-value> * 100%), transparent)",
				"accent-text": "color-mix(in srgb, var(--color-accent-content) calc(<alpha-value> * 100%), transparent)",
				"negative": "color-mix(in srgb, var(--color-negative-surface) calc(<alpha-value> * 100%), transparent)",
				"negative-inverse": "color-mix(in srgb, var(--color-negative-inverse) calc(<alpha-value> * 100%), transparent)",
				"negative-text": "color-mix(in srgb, var(--color-negative-content) calc(<alpha-value> * 100%), transparent)",
			},
			textColor: {
				"primary": "var(--color-brand-content)",
				"accent": "var(--color-accent-content)",
			},
			spacing: {
				"2xs": "var(--spacing-2xs)",
				"xs": "var(--spacing-xs)",
