...
| Variable | Purpose | Ex. Tailwind Utilities |
|----------|---------|-------------------|
| `--color-brand-surface` | Primary brand color | `bg-brand`<br/>`border-brand` |
| `--color-brand-inverse` | Content color on primary backgrounds | `text-brand-inverse` |
| `--color-brand-content` | Primary text color | `text-brand-text` |
| `--color-accent-surface` | Accent color for highlights | `bg-accent`<br/>`border-accent` |
| `--color-accent-inverse` | Content color on accent backgrounds | `text-accent-inverse` |
| `--color-accent-content` | Accent text color | `text-accent-text` |
| `--color-negative-surface` | Error and negative states | `bg-negative`<br/>`border-negative` |
| `--color-negative-inverse` | Content color on negative backgrounds | `text-negative-inverse` |
| `--color-negative-content` | Negative text color | `text-negative-text` |
...
:root {
    ...
    --color-brand-surface: var(--color-content-stark);
    --color-brand-inverse: var(--color-page);
    --color-brand-content: var(--color-content-stark);
    --color-accent: oklch(90.56% 0.1724 148.7);
    --color-accent-inverse: var(--color-950);
    --color-accent-content: oklch(70.7% 0.229867 143.9);
    --color-negative: oklch(63.68% 0.2078 25.33);
    --color-negative-inverse: oklch(100% 0 0);
...
.dark {
    ...
    --color-content-subtle: var(--color-500);
    --color-accent-content: oklch(90.56% 0.1724 148.7);
}
